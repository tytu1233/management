...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <actionOverrides>
        ...
        <content>MomentumEvents</content>
    ...
    <actionOverrides>
        <actionName>View</actionName>
        <comment>Action override created by Lightning App Builder during activation.</comment>
        <content>MomentumContact</content>
        <formFactor>Large</formFactor>
        <skipRecordTypeSelect>false</skipRecordTypeSelect>
        <type>Flexipage</type>
    ...
    <brand>
        <headerColor>#A101FE</headerColor>
        <logo>logoremovebgpreview</logo>
        <logoVersion>1</logoVersion>
        <shouldOverrideOrgTheme>false</shouldOverrideOrgTheme>
    </brand>
    <description>Application for a event management company</description>
    ...
    <utilityBar>Momentum_Events_UtilityBar</utilityBar>
</CustomApplication>
